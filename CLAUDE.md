...
4. **Scripts** (`/scripts`) - Node.js utilities for migration and maintenance
...
# Sync/generate static data when needed
bun run sync
```
...
│   ├── lib/
│   │   └── notion.ts         # Legacy Notion API client and data fetching
│   ├── data/
